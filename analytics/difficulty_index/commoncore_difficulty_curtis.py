...
def get_commoncore_node_difficulty():
    """
    Parse the json file from UCLA Curtis Center to get relationship among
    the Common Core Standards. Based on the ancestry in the directed
    graph layout, compute the difficulty of each node.

    There can be different rules for assigning a difficulty score and
    some of them are defined as functions in this module.
    """
...
if __name__ == "__main__":
    track_diff = get_commoncore_node_difficulty()
